    ...
    fn validate_path(&self, path: &str) -> crate::Result<PathBuf> {
        ...
        let canonical_path = if requested_path.exists() {
            ...
            let parent = requested_path.parent().ok_or_else(|| {
                crate::Error::Input("Invalid path: no parent directory".to_string())
            })?;
...
impl FnExecutor<ShowTreeArgs, TreeResult> for ShowTreeTool {
    async fn call(&self, args: ShowTreeArgs) -> crate::Result<TreeResult> {
...
impl FnExecutor<CreateFileArgs, FileOperationResult> for CreateFileTool {
    async fn call(&self, args: CreateFileArgs) -> crate::Result<FileOperationResult> {
...
impl FnExecutor<ConcatenateFilesArgs, ConcatenateResult> for ConcatenateFilesTool {
    async fn call(&self, args: ConcatenateFilesArgs) -> crate::Result<ConcatenateResult> {
        log::debug!(
...
impl FnExecutor<EditFileArgs, EditResult> for EditFileTool {
    async fn call(&self, args: EditFileArgs) -> crate::Result<EditResult> {
...
impl FnExecutor<DeleteArgs, FileOperationResult> for DeleteTool {
    async fn call(&self, args: DeleteArgs) -> crate::Result<FileOperationResult> {
...
impl FnExecutor<CopyArgs, FileOperationResult> for CopyTool {
    async fn call(&self, args: CopyArgs) -> crate::Result<FileOperationResult> {
...
impl FnExecutor<FileInfoArgs, FileInfo> for FileInfoTool {
    async fn call(&self, args: FileInfoArgs) -> crate::Result<FileInfo> {
